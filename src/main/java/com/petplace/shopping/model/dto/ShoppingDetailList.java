...
//    private String detailImg;			// 상세이미지
	...
	public ShoppingDetailList(String productNo, String productName, int price, String productImg, int fileLevel, int reviewCount, int star, String company, String ingredient, String origin, int productWeight, int kcal) {
