...
public class Purchase {
	...
	public Purchase(int purchaseNo, String memberId, int productNo, int quantity, int amountPrice, String purchaseDate,
			String payType, String request, String cardNo, String wayBill, String multiDetail) {
		super();
	...
	public String toString() {
		return "Purchase [purchaseNo=" + purchaseNo + ", memberId=" + memberId + ", productNo=" + productNo
				+ ", quantity=" + quantity + ", amountPrice=" + amountPrice + ", purchaseDate=" + purchaseDate
				+ ", payType=" + payType + ", request=" + request + ", cardNo=" + cardNo + ", wayBill=" + wayBill
